...
import { useHerbalism } from "@/hooks/useQueries";
...
export function HerbalismCalculator() {
  const { data, isLoading, error, refetch } = useHerbalism();
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-6">
        <div
          data-ocid="herbalism.error_state"
        ...
        >
          ...
          <div>
            <p className="font-semibold">Failed to load herbalism data</p>
      ...
      results={
        <div className="space-y-2">
          ...
          {filteredData.length === 0 ? (
            <div
              data-ocid="herbalism.empty_state"
