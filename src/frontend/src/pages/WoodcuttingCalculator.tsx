...
export function WoodcuttingCalculator() {
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-6">
        <div
          data-ocid="woodcutting.error_state"
        ...
        >
          ...
          <div>
            <p className="font-semibold">Failed to load woodcutting data</p>
      ...
      results={
        <div className="space-y-2">
          ...
          {filteredData.length === 0 ? (
            <div
              data-ocid="woodcutting.empty_state"
