...
export class Backend implements backendInterface {
    ...
    async clearPrice(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getClaims(): Promise<Array<GrowingClaim>> {
        if (this.processError) {
            try {
    ...
    async getMyClaims(): Promise<Array<GrowingClaim>> {
        if (this.processError) {
            try {
    ...
    async getPrices(): Promise<Array<[bigint, PriceEntry]>> {
        if (this.processError) {
            try {
    ...
    async removeClaim(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeClaim(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setClaim(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setClaim(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPrice(arg0: bigint, arg1: string, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPrice(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
